...
/****** Object:  Job [5 minuts activity]    Script Date: 19/04/08 10:17:27 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 19/04/08 10:17:27 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Search for Player]    Script Date: 19/04/08 10:17:27 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Search for Player', 
		...
		@command=N'update [dbo].[utbl_Players]
